...
export const EXPENSE_CATEGORIES: CategoryConfig[] = [
  ...
  },
  {
    ...
    tooltip: "Factoring company commission and fees (J D Factors etc.). 100% deductible as financing cost.",
    deductionRate: 1.0,
    icon: "Percent",
    color: "red",
  },
  {
    id: "payroll",
    label: "Payroll / Wages",
    tooltip: "Employee wages, salaries, and payroll-related expenses.",
    deductionRate: 1.0,
    icon: "Users",
    color: "cyan",
  },
  {
    id: "subcontractor",
    label: "Subcontractor",
    tooltip: "Payments to subcontractors and independent drivers.",
    deductionRate: 1.0,
    icon: "UserCheck",
    color: "sky",
  },
  {
    ...
    tooltip: "Accounting, legal, consulting, and other professional service fees.",
    deductionRate: 1.0,
    icon: "Briefcase",
    color: "violet",
  },
  {
    id: "rent_lease",
    label: "Rent / Lease",
    tooltip: "Equipment lease payments, vehicle lease, office/yard rent.",
    deductionRate: 1.0,
    icon: "Building",
    color: "fuchsia",
  },
  {
    id: "loan_interest",
    label: "Loan Interest",
    tooltip: "Interest on business loans (not principal). Only the interest portion is deductible.",
    deductionRate: 1.0,
    icon: "Landmark",
    color: "rose",
  },
...
export const categoryColors: Record<string, string> = {
  ...
  factoring_fees: "bg-red-500/20 text-red-500",
  payroll: "bg-cyan-500/20 text-cyan-500",
  subcontractor: "bg-sky-500/20 text-sky-500",
